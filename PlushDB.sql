...
--
-- Host: 127.0.0.1    Database: PlushDB
-- ------------------------------------------------------
...
CREATE TABLE `products` (
  ...
  KEY `storage-fk` (`storage_id`),
  CONSTRAINT `category-fk` FOREIGN KEY (`category_id`) REFERENCES `categories` (`id`),
  CONSTRAINT `storage-fk` FOREIGN KEY (`storage_id`) REFERENCES `storages` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Dumping events for database 'PlushDB'
--

--
-- Dumping routines for database 'PlushDB'
--
...
-- Dump completed on 2020-09-04  5:08:48
